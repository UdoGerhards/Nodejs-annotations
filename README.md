...
| **Injection**   |               |                 |                      |                                                                                                                                                                                                                                                                                            |
|             | Autowire      | Class                | _```@Autowire()```| Marks a class as autowire target. The class will be examinated and properties which have the same name as a bean from the context will be used as injection target.                                                                                                                             |                                                                                                                                                                                                                                                                                         |
|             | Inject        | Property or Function | _```@Inject("...")```| Injects a bean, component, service, controller or configuration                                                                                                                                                                                                                                |
