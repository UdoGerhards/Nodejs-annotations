...
class BeanParser extends BaseParser {
    ...
    parseOpenXMLTag(currentTag, propertyStack, namespaceStack, applicationStack, beanStructure) {
        ...
        if (attributes.inherits) {
            ...
            beanStructure = namespaceMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, applicationStack, beanStructure);
        }
        ...
        if (attributes.init) {
            ...
            beanStructure = initMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, applicationStack, beanStructure);
        }
        ...
        if (attributes.run) {
            ...
            beanStructure = runMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, applicationStack, beanStructure);
        }
    ...
    parseCloseXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure) {
        ...
        if (propertyStack.length > 0) {
            ...
            let strucktEntry = propertyMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, applicationStack, null);
