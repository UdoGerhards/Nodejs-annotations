...
class BeanParser extends BaseParser {
    ...
    parseOpenXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure) {
        ...
        let xmlMapper = instance._getXMLMapper(currentTag.name);
            ...
            if (attributes.inherits) {
                ...
                beanStructure = namespaceMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure);
            }
            ...
            if (attributes.init) {
                ...
                beanStructure = initMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure);
            }
            ...
            if (attributes.run) {
                ...
                beanStructure = runMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure);
            }
            ...
            logger.trace("    Initializing new " + currentTag.name + " => " + namespaceString);
    ...
    parseCloseXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, beanStructure) {
        ...
        if (propertyStack.length > 0) {
            ...
            let strucktEntry = propertyMapper.parseOpenXMLTag(currentTag, propertyStack, namespaceStack, context, applicationStack, null);
