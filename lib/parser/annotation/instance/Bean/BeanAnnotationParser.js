...
class BeanParser extends BaseParser {
    ...
    parseXML(currentTag, propertyStack, context, stack, beanStructure) {
        ...
        let beaXmlMapper = instance.xmlMapper[annotation];

        beanStructure = beaXmlMapper.parseXML(currentTag, annotation, beanStructure);

        /*
         * Add Namespace
         */
        let namespaceMapper = instance.xmlMapper("Namespace");
        //beanStructure = namespaceMapper.parseXML(currentTag, annotation, beanStructure);
        //beanStructure = instance.parseXML(currentTag, propertyStack, context, stack, beanStructure);
