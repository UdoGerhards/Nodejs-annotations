...
class Prototype extends BaseParser {
    ...
    _stage(annotationInformation, beanStructure, applicationStructure) {
        ...
        var sourceCodeClassName = beanStructure.descriptor.className;
        ...
        beanStructure.beanName = beanName || sourceCodeClassName;         // Either we have dedicated descriptor or we take the property name as bean name
