'use strict';
var PointCutAnnotation = require("../../../../annotation/aop/PointCut/PointCutAnnotationClass")
...
class PointCutParser extends BaseAnnotationParser {
    ...
    static get SUPPORTS() {
        return [PointCutAnnotation.name]
    };
...
''
    ...
    _aop_initialize(annotationInformation, beanStructure, applicationStructure) {
        ...
        //console.log(applicationStructure.nameToNamespace);
