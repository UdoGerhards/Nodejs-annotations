...
var AroundAnnotation = require("../../../../annotation/aop/Around/AroundAnnotationClass.js")
    , BeanParser = require("../../instance/Bean/BeanAnnotationParser.js")
    , path = require("path")
    , util = require("util");


class AroundAnnotationParser extends BeanParser {

    static get SUPPORTS() {
        return [AroundAnnotation.name]
    };
...
module.exports = exports = AroundAnnotationParser;