...
class QualifierParser extends BaseParser {
    ...
    parseOpenXMLTag(currentTag, propertyStack, namespaceString, context, applicationStack, beanStructure) {
        ...
        if (currentTag.name == "Property") {
            ...
            beanStructure = propertyMapper.parseOpenXMLTag(currentTag, annotation, beanStructure);
        ...
        if (currentTag.name == "Entry") {
            ...
            let propertyMapper = instance.xmlMapper["Entry"];
            beanStructure = propertyMapper.parseOpenXMLTag(currentTag, annotation, beanStructure);
