...
class Esprima_ExpressionStatement extends Esprima_Base {
        ...
        try {
            if ((annotation.TYPE & global.TYPE_ANNOTATION_TARGET) || (annotation.TYPE & global.TYPE_ANNOTATION_BEAN_CONTEXT_AWARE)) {
                try {
                    ...
                    do {
                        /*
                        if (objectStruct.property.name != "prototype") {
                            namestring += sep+objectStruct.property.name;
                            sep = ":"
                        }

                        if (objectStruct.name && propertyStack.length > 1) {
                            propertyStack.push(objectStruct.name);
                        }
                        */
...
module.exports= exports = Esprima_ExpressionStatement;
