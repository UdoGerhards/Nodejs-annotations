...
Factory.prototype._generateClassDiagramm = function (applicationStructure) {
    ...
    //console.log(groups);
    //console.log(classDefsOrig);

    applicationStructure._parameters.projectLandScape.imageName = "test";
    applicationStructure._parameters.projectLandScape.imageType = "png"
