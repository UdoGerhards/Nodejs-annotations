...
var util = require("util")
    ...
    , diagramTool = require("../diagram/diagramTool");
...
Factory.prototype.init = function () {
     ...
     * Structure parser
     */
    instance._initializeStructureParser(annotationParserList, tokenParserList);
 ...
 */
Factory.prototype._initializeStructureParser = function (annotationParserList, tokenParserList) {
    var instance = this;
    var logger = instance.logger;
...
Factory.prototype._humanReadable = function(valueObject) {
