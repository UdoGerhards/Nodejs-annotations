...
class Factory extends EventEmitter {
    ...
    async process(parameters) {
        ...
        if (parameters.file) {
            ...
            return applicationContext.then(function(beanStructure){
                ...
                return res.then(function(applicationStructure){

                    return instance._returnContext(applicationStructure);
            ...
            if (pluginCounter > 0) {
                ...
                Promise.all(parsingPromises).then(function(result){
                    ...
                    let context = instance._returnContext(applicationStructure);
                    resolveFunc(context);
                })
            }
    ...
    _returnContext(applicationStructure) {
    ...
    cleanApplicationStructure(applicationStructure) {
        ...
        applicationStructure.classToBean = null;
        delete applicationStructure.classToBean;


        for (var beanName in applicationStructure["nameToNamespace"]) {

            if (applicationStructure["nameToNamespace"][beanName].descriptor) {
                var annotationInformation = {

                    "annotationValue": applicationStructure["nameToNamespace"][beanName].descriptor.annotationValue,
                    "annotation": applicationStructure["nameToNamespace"][beanName].descriptor.annotation,
                    "parentBeanName": applicationStructure["nameToNamespace"][beanName].descriptor.parentBeanName
                };
            }

            applicationStructure["nameToNamespace"][beanName].descriptor = {};
            applicationStructure["nameToNamespace"][beanName].descriptor.annotationInformation = annotationInformation;
            //delete applicationStructure["nameToNamespace"][beanName].descriptor;

            applicationStructure["nameToNamespace"][beanName].resolve = null;
            delete applicationStructure["nameToNamespace"][beanName].resolve;

            applicationStructure["nameToNamespace"][beanName].reject = null;
            delete applicationStructure["nameToNamespace"][beanName].reject;

            applicationStructure["nameToNamespace"][beanName].annotationPromises = null;
            delete applicationStructure["nameToNamespace"][beanName].annotationPromises;

            applicationStructure["nameToNamespace"][beanName].loader = null;
            delete applicationStructure["nameToNamespace"][beanName].loader;

            if (applicationStructure["nameToNamespace"][beanName].structure) {
                applicationStructure["nameToNamespace"][beanName].structure.forEach(function (struct) {
