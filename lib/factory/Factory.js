...
Factory.prototype._generateClassDiagramm = function(applicationStructure) {
    ...
    var params = applicationStructure._parameters;
    var projectLandscapeDir = params.projectLandscapeDir;
    var canvas = params.canvas+"\n";
    if (canvas) {
        canvas = "";
    }
    var imageType = params.mapType || "svg";
    var showBeanNames = params.showBeanNames || false;
    var useBeanNames = params.useBeanNames || false;
