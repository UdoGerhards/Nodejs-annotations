...
Factory.prototype._prepareBeans = function() {
    ...
    var structureParserBean = {
        ...
        descriptor: {
            ...
            annotationValue: "(\"AnnotationStructureParser\")"
        }
    };
    ...
    var dependencyBuilderBean = {
        ...
        descriptor: {
            annotation: DummyAnnotation,
            annotationValue: "(\"AnnotationDependencyBuilder\")"
        }
    };
    ...
    var contextBuilderBean = {
        ...
        descriptor: {
            annotation: DummyAnnotation,
            annotationValue: "(\"AnnotationContextBuilder\")"
        }
    };
    ...
    var factoryBean = {
        ...
        descriptor: {
            annotation: DummyAnnotation,
            annotationValue: "(\"AnnotationFactory\")"
        }
    };
...
Factory.prototype._scanForPlugins = function(additionalPlugins) {
    ...
    var parserContext = instance._prepareBeans(); // Get all parsers, factory and contextbuilder as normal beans
