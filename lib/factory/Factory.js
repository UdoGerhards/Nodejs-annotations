...
Factory.prototype.process = function(parameters) {
    ...
    // Scan for plugins
    var pluginInitPromises = instance._scanForPlugins(additionalPlugins, parameters);
    if (pluginInitPromises) {
        ...
        return Promise.all(pluginInitPromises).then(function (results) {
            ...
            return Promise.all(applicationParsingPromise).then(function(result){
                return result;
            });
        });
...
Factory.prototype._scanForPlugins = function(additionalPlugins, params) {
    ...
    var searchInPath = _.isArray(additionalPlugins)?additionalPlugins:pluginPath;
...
Factory.prototype._parseFiles = function (parameters) {
    ...
    var parsePromise = new Promise(function(resolve, reject){
        ...
        contextBuilder.on(global.phase._BUILD_FINISHED_, function(applicationStack){
            ...
            instance.stacks.push(applicationStack);
