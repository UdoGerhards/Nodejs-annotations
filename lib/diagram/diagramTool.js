...
const __createObjectModel = function (applicationStructure, useBeanNames, excludeResources, avoidDefaultMethods, showAnnotations) {
    ...
    for (var beanName in applicationStructure[0]["nameToNamespace"]) {
        ...
        if (annotation.name == "Prototype" || (annotation.name == "Resource" && excludeResources) || (!applicationStructure[0]["nameToNamespace"][beanName].path && excludeResources)) {
            continue;
        }
        ...
        try {
            ...
            objMethods = objMethods.sort().filter(function (e, i, arr) {
                ...
                if (e != arr[i + 1] && !restricted.includes(e) && !baseObjProps.includes(e) && typeof applicationStructure[0]["nameToNamespace"][beanName]._instance[e] == 'function') {
                    ...
                    if (applicationStructure[0]["nameToNamespace"][beanName].jsDoc && applicationStructure[0]["nameToNamespace"][beanName].jsDoc.param) {

                        var params = applicationStructure[0]["nameToNamespace"][beanName].jsDoc.param;
        ...
        obProperties.forEach(function (property) {
            ...
            if (applicationStructure[0]["nameToNamespace"][beanName].jsDoc && applicationStructure[0]["nameToNamespace"][beanName].jsDoc.type) {

                var types = applicationStructure[0]["nameToNamespace"][beanName].jsDoc.type;
               ...
               // console.log(applicationStructure[0]["nameToNamespace"][beanName].jsDoc);
        ...
        var file = null;
        if (applicationStructure[0]["nameToNamespace"][beanName].path) {
            file = path.basename(applicationStructure[0]["nameToNamespace"][beanName].path);
        }
