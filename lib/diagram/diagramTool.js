...
const __createObjectModel = function(applicationStructure, useBeanNames) {
...
async function draw(applicationStructure, useBeanNames) {
    ...
    const objectModel = __createObjectModel(applicationStructure, useBeanNames);
    ...
    // fs.writeFileSync(inagePath, buffer, 'base64');
