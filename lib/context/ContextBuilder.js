    ...
    _parseBeanStructure(parseInformation) {
        ...
        if (mainAnnotation) {
            ...
            try {
                 ...
                 * Process main childs
                 */
                if (Array.isArray(mainAnnotation.childs) && mainAnnotation.childs.length > 0) {
                    instance._processAnnotations(mainAnnotation.childs, beanStructure, applicationStack);
                }
