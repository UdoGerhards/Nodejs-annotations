...
import * as  wildcard from 'node-wildcard';
 ...
 */
export default class FoundationXMLParser {
    ...
    constructor() {
        ...
        instance.path = path;
        instance.util = util;
        instance.setProperty = setProperty;
    ...
    _parse(data) {
        ...
        var stack = {
            ...
            pushElement: function (indexPath, content) {
                ...
                instance.setProperty(newObjectStack[currentID], propertyStack.join("."), instance);
            },
                ...
                if (master) {
                    ...
                    for (var index = 0; index < keys.length; index++) {
                        ...
                        if (keys[index] != "") {
                            ...
                            instance.setProperty(newObject, property, instance);
                ...
                case "bean":
                    ...
                    if (targetSrc) {
                        ...
                        if (fs.existsSync(src)) {
                             ...
                             * Resource
                             */
                            instance = require(attributes.src);
                        }
