...
class ClazzStructAnalyzer {
    ...
    constructor() {
        ...
        instance.Analyzer = [];
        instance._AnalyzerByAnnotation {};
        instance._AnnotationClasses = {};
    }
    ...
    init() {
        ...
        instance.Analyzer.forEach((analyzer) => {
            ...
            let responsibleFor = analyzer.getAnnotation();

            responsibleFor.foreach((ClazzName) => {
                instance._AnalyzerByAnnotation[ClazzName] = analyzer;
            });
        });
    }
                ...
                astTree = esprima.parse(file.data, {
                    ...
                    if (node.trailingComments) {
                        ...
                        mainAnnotation.every(function (annotation) {
                            ...
                            let analyzer = instance._AnalyzerByAnnotation[annotation.constructor.name];
                        ...
                        Promise.all(mainCollection).then(function (mainAnnotation) {
                            ...
                            let waitPromise = new Promise(function (resolve, reject) {
                                ...
                                support.every(function (supportAnnotation) {
                                    let analyzer = instance._AnalyzerByAnnotation[supportAnnotation.constructor
                                        .name];
                    ...
                    try {
                        ...
                        if (match && match[0]) {
                            ...
                            if (typeof annotation !== "undefined" && annotation && annotation.trim() !== "") {
                                ...
                                let AnnotationClass = instance._AnnotationClasses[annotation];
